 ...
 */
class ProxyTestling : public Ping {
   private:
    ProxyTestling();
   ...
   public:
    ...
    // Here, you need to add all methods which are protected in Ping and which are needed for the test cases.
};

/**
 * The actual testsuite starts here.
 */
class PingTest : public CxxTest::TestSuite {
 private:
  ProxyTestling *dt;
 ...
 private:
   ...
   */
  PingTest &operator=(const PingTest & /*obj*/);
};
